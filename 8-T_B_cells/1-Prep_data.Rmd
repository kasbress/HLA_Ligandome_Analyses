---
title: "Generate peptide database T and B cells"
...
test.set %>% 
  ...
  pull(peptides) %>% 
  map2(names(.), ~write_lines(.x, paste0("./Output/peptides/T-B_Peptides_", .y, ".tsv")))

write_tsv(test.set, "./Output/T-B_Test_Table.tsv")
```
