---
title: "Generate peptide database Ovarian"
...
test.set %>% 
  ...
  pull(peptides) %>% 
  map2(names(.), ~write_lines(.x, paste0("./Output/peptides/ovarian_Peptides_", .y, ".tsv")))

write_tsv(test.set, "./Output/ovarian_Test_Table.tsv")
```
